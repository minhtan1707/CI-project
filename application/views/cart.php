<div class="container" style="max-width:940px;">
    ...
    <div class="row">
        ...
        <div class="col-3 mt-3">
            <div class="card" style="width:14rem;min-height:500px;">
                <a href=<?php echo site_url( 'product/item/'.$product[ 'product_id']); ?>>
                    <img class="card-img-top" src="<?php echo base_url('/assets/images/').$product['image_file'];?>">
                </a>
                <div class="card-body">
                    <h5 class="card-title">
    ...
    <div class="d-flex justify-content-end mt-5">
        ...
        <a href="<?php echo site_url('cart?act=clear')?>" class="btn btn-danger ml-2">Clear Cart</a>
    </div>